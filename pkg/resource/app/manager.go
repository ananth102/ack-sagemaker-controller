...
// +kubebuilder:rbac:groups=sagemaker.services.k8s.aws,resources=apps,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=sagemaker.services.k8s.aws,resources=apps/status,verbs=get;update;patch
