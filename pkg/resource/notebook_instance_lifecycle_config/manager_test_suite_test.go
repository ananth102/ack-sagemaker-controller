...
// TestNotebookInstanceLifecycleConfigTestSuite runs the test suite for NotebookInstanceLifecycleConfig
...
func (d *testRunnerDelegate) EmptyServiceAPIOutput(apiName string) (interface{}, error) {
	...
	case "UpdateNotebookInstanceLifecycleConfigWithContext":
		var output svcsdk.UpdateNotebookInstanceLifecycleConfigOutput
		return &output, nil
