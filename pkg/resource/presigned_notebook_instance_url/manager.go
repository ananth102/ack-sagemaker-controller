...
// +kubebuilder:rbac:groups=sagemaker.services.k8s.aws,resources=presignednotebookinstanceurls,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=sagemaker.services.k8s.aws,resources=presignednotebookinstanceurls/status,verbs=get;update;patch
